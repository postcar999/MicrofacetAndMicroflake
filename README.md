...
$$
\underbrace{\frac{a\rho}{4{\sigma_s(\omega)}}\alpha(|\omega' \cdot h(\omega, -\omega')|)(D(h(\omega, -\omega'))+D(-h(\omega, -\omega')))}_{=f_p(\omega' \to \omega)}=
\underbrace{\frac{a\rho}{4\space\sigma_s}\alpha(cos\frac{\theta}{2})(D(h(\omega, -\omega'))+D(-h(\omega, -\omega')))}_{=f_p(cos\theta)},
$$
