...
$$
\frac{a\rho}{4{\sigma_s(\omega)}}\alpha(|\omega' \cdot h(\omega, -\omega')|)(D(h(\omega, -\omega'))+D(-h(\omega, -\omega')))\to
\frac{a\rho}{4\space\sigma_s}\alpha(cos\frac{\theta}{2})(D(h(\omega, -\omega'))+D(-h(\omega, -\omega'))),
$$
